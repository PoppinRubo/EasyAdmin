...
CREATE TABLE `sys_button` (
  ...
  PRIMARY KEY (`Id`)
) ENGINE=MyISAM AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COMMENT='按钮表';
...
CREATE TABLE `sys_module_button` (
  ...
  `IsDel` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否删除',
  PRIMARY KEY (`Id`)
) ENGINE=MyISAM AUTO_INCREMENT=22 DEFAULT CHARSET=utf8mb4 COMMENT='系统模块、按钮关系表';
...
CREATE TABLE `sys_role_button` (
  ...
  `IsDel` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否删除',
  PRIMARY KEY (`Id`)
) ENGINE=MyISAM AUTO_INCREMENT=22 DEFAULT CHARSET=utf8mb4 COMMENT='角色、按钮、模块关系表/按钮权限控制表';
...
INSERT INTO `admin`.`sys_button` (`Id`,`Name`,`EnglishName`,`Icon`,`Sort`,`Remark`,`CreateTime`,`CreateUser`,`ModifyTime`,`ModifyUser`,`IsValid`,`IsDel`) VALUES (1, '添加', 'add', 'layui-icon-add-1', 10, '添加按钮', '2018-07-12 20:00:00', 1, '2018-07-12 20:00:00', 1, 1, 0),(2, '编辑', 'edit', 'layui-icon-edit', 30, '编辑按钮', '2018-07-12 20:00:00', 1, '2018-07-12 20:00:00', 1, 1, 0),(3, '删除', 'remove', 'layui-icon-delete', 40, '删除按钮', '2018-07-12 20:00:00', 1, '2018-07-12 20:00:00', 1, 1, 0),(4, '添加子级', 'addSon', 'layui-icon-add-1', 20, '添加子级按钮', '2018-07-12 20:00:00', 1, '2018-07-12 20:00:00', 1, 1, 0),(5, '按钮配置', 'moduleButton', 'icon-link2', 50, '模块配置按钮关联', '2018-07-12 20:00:00', 1, '2018-07-12 20:00:00', 1, 1, 0),(6, '自动排序', 'sorting', 'icon-sort-amount-asc', 60, '自动排序按钮', '2018-07-12 20:00:00', 1, '2018-07-12 20:00:00', 1, 1, 0),(7, '权限配置', 'roleModule', 'icon-squarespace', 70, '角色关联模块', '2018-07-12 20:00:00', 1, '2018-07-12 20:00:00', 1, 1, 0),(8, '角色配置', 'userRole', 'icon-squarespace', 80, '用户关联角色', '2018-07-12 20:00:00', 1, '2018-07-12 20:00:00', 1, 1, 0),(9, '密码重置', 'resetPassword', 'icon-back', 90, '用户密码重置', '2018-07-12 20:00:00', 1, '2018-07-12 20:00:00', 1, 1, 0),(10, '调整层级', 'move', 'icon-hand', 100, '调整菜单层级', '2018-07-12 20:00:00', 1, '2018-07-12 20:00:00', 1, 1, 0);
UNLOCK TABLES;
COMMIT;
BEGIN;
