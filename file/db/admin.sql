...
MySQL Backup
Database: admin
Backup Time: 2018-11-25 00:30:55
*/
...
CREATE TABLE `sys_role_button` (
  ...
  `IsDel` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否删除',
  PRIMARY KEY (`Id`)
) ENGINE=MyISAM AUTO_INCREMENT=20 DEFAULT CHARSET=utf8mb4 COMMENT='角色、按钮、模块关系表/按钮权限控制表';
