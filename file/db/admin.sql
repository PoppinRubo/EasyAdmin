...
MySQL Backup
Database: admin
Backup Time: 2018-11-24 23:40:06
*/
...
CREATE TABLE `sys_button` (
  ...
  PRIMARY KEY (`Id`)
) ENGINE=MyISAM AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COMMENT='按钮表';
...
CREATE TABLE `sys_module_button` (
  ...
  `IsDel` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否删除',
  PRIMARY KEY (`Id`)
) ENGINE=MyISAM AUTO_INCREMENT=20 DEFAULT CHARSET=utf8mb4 COMMENT='系统模块、按钮关系表';
...
CREATE TABLE `sys_role_button` (
  ...
  `IsDel` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否删除',
  PRIMARY KEY (`Id`)
) ENGINE=MyISAM AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COMMENT='角色、按钮、模块关系表/按钮权限控制表';
...
INSERT INTO `admin`.`sys_role_button` (`Id`,`RoleId`,`ModuleId`,`ButtonId`,`CreateTime`,`CreateUser`,`ModifyTime`,`ModifyUser`,`IsValid`,`IsDel`) VALUES (1, 1, 6, 1, '2018-07-12 20:00:00', 1, '2018-07-12 20:00:00', 1, 1, 0),(2, 1, 6, 2, '2018-07-12 20:00:00', 1, '2018-07-12 20:00:00', 1, 1, 0),(3, 1, 6, 3, '2018-07-12 20:00:00', 1, '2018-07-12 20:00:00', 1, 1, 0),(4, 1, 6, 6, '2018-07-12 20:00:00', 1, '2018-07-12 20:00:00', 1, 1, 0),(5, 1, 6, 7, '2018-07-12 20:00:00', 1, '2018-07-12 20:00:00', 1, 1, 0);
UNLOCK TABLES;
COMMIT;
BEGIN;
...
INSERT INTO `admin`.`sys_user` (`Id`,`Account`,`Password`,`Username`,`Gender`,`LoginTimes`,`LastLoginTime`,`CreateTime`,`CreateUser`,`ModifyTime`,`ModifyUser`,`IsValid`,`IsDel`) VALUES (1, 'admin', '666666', '超级管理员', 1, 0, '2018-07-12 20:00:00', '2018-07-12 20:00:00', 1, '2018-07-12 20:00:00', 1, 1, 0);
UNLOCK TABLES;
COMMIT;
BEGIN;
